...
func init() {
	...
	// User requests
	beego.Router("/ajax/image/new", &controllers.AjaxController{}, "get:GetImageUploadStatus;post:PostImage")
	...
	beego.InsertFilter("/ajax/image/new", beego.BeforeRouter, controllers.AuthRequest)
